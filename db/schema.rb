...
ActiveRecord::Schema.define(version: 20160416123812) do

  create_table "bookcats", force: :cascade do |t|
    t.string   "name"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.date     "birthday"
    t.text     "about"
    t.string   "average_movies"
    t.boolean  "read_more",              default: false, null: false
